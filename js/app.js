...
function editarDenominacionDesdeCatalogo(id) {
  ...
  document.getElementById('denom-fecha-emision').value = item.fecha_emision; // Fecha completa
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  form.onsubmit = async function (e) {
    ...
    const fecha_emision = document.getElementById('denom-fecha-emision').value; // Fecha completa
